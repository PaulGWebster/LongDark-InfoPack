...
File types (and what can open them - not exhaustive):

* ods = OpenDocument Format, this can be opened with any recent openoffice, msoffice or office package.

* jpg = Standard image format openable by pretty much everything

* png = Standard image format openable by pretty much everything

* xcf = GIMP / GNU Image Manipulation format file, openable by GIMP only - I think
